// Cette fonction remplace celle de ton fichier HTML pour gérer les vidéos
window.createNewsCard = (newsItem) => {
    const formattedDate = newsItem.date.split('-').reverse().join('/');
    ...
    if (newsItem.type === 'video') {
        mediaHtml = `<video class="news-media-container" controls muted poster="COP.png">
